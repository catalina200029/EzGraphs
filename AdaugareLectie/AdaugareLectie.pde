...
String faCodGraf() {
	...
	codGraf+=currForm.forms.get(1).grafLectie.graf.size()+"\n";
	for (i=0;i<currForm.forms.get(1).grafLectie.nodes.size();i++) {
		codGraf+=str(currForm.forms.get(1).grafLectie.nodes.get(i).basePos.x)+" ";
		codGraf+=currForm.forms.get(1).grafLectie.nodes.get(i).basePos.y+" ";
